...
function settingsPageReducer(state = initialState, action) {
  switch (action.type) {
    ...
    case ENTER_NEW_PASSWORD_ERROR:
      return state.set('errorPassword', action.error).set('message', null);
    ...
    case ENTER_NEW_NAME_ERROR:
      return state.set('errorName', action.error).set('message', null);
    ...
    case ENTER_NEW_SURNAME_ERROR:
      return state.set('errorSurname', action.error).set('message', null);
    ...
    case ENTER_NEW_EMAIL_ERROR:
      return state.set('errorEmail', action.error).set('message', null);
    default:
      return state;
  }
}
